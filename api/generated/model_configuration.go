 ...
 * Weather App app API
 *
 * API to access and configure the Weather App app
 *
 * API version: 1.0.0
 */
...
type Configuration struct {
	...
	// List of Eliona project ids for which this device should collect data. For each project id all smart devices are automatically created as an asset in Eliona. The mapping between Eliona is stored as an asset mapping in the Weather App app.
