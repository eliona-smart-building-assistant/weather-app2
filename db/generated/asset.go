...
type Asset struct {
	...
	LocationName string  `boil:"location_name" json:"location_name" toml:"location_name" yaml:"location_name"`
...
var AssetWhere = struct {
	...
	LocationName whereHelperstring
	Lat          whereHelperfloat64
	Lon          whereHelperfloat64
	AssetID      whereHelperint32
}{
	ID:           whereHelperint64{field: "\"weather_app2\".\"asset\".\"id\""},
	ProjectID:    whereHelperstring{field: "\"weather_app2\".\"asset\".\"project_id\""},
	LocationName: whereHelperstring{field: "\"weather_app2\".\"asset\".\"location_name\""},
	Lat:          whereHelperfloat64{field: "\"weather_app2\".\"asset\".\"lat\""},
	Lon:          whereHelperfloat64{field: "\"weather_app2\".\"asset\".\"lon\""},
	AssetID:      whereHelperint32{field: "\"weather_app2\".\"asset\".\"asset_id\""},
}
...
var (
	assetAllColumns            = []string{"id", "project_id", "location_name", "lat", "lon", "asset_id"}
	assetColumnsWithoutDefault = []string{"project_id", "location_name", "lat", "lon", "asset_id"}
...
func Assets(mods ...qm.QueryMod) assetQuery {
	mods = append(mods, qm.From("\"weather_app2\".\"asset\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"weather_app2\".\"asset\".*"})
	}
...
func FindAsset(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Asset, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"weather_app2\".\"asset\" where \"id\"=$1", sel,
	)
...
func (o *Asset) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"weather_app2\".\"asset\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"weather_app2\".\"asset\" %sDEFAULT VALUES%s"
		}
...
func (o *Asset) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"weather_app2\".\"asset\" SET %s WHERE %s",
...
func (o AssetSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"weather_app2\".\"asset\" SET %s WHERE %s",
...
func (o *Asset) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"weather_app2\".\"asset\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func (o *Asset) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"weather_app2\".\"asset\" WHERE \"id\"=$1"
...
func (o AssetSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"weather_app2\".\"asset\" WHERE " +
...
func (o *AssetSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"weather_app2\".\"asset\".* FROM \"weather_app2\".\"asset\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, assetPrimaryKeyColumns, len(*o))
...
func AssetExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"weather_app2\".\"asset\" where \"id\"=$1 limit 1)"
