...
var ConfigurationWhere = struct {
	...
	ID:              whereHelperint64{field: "\"weather_app2\".\"configuration\".\"id\""},
	TenantID:        whereHelperstring{field: "\"weather_app2\".\"configuration\".\"tenant_id\""},
	SiteID:          whereHelpernull_String{field: "\"weather_app2\".\"configuration\".\"site_id\""},
	RefreshInterval: whereHelperint32{field: "\"weather_app2\".\"configuration\".\"refresh_interval\""},
	RequestTimeout:  whereHelperint32{field: "\"weather_app2\".\"configuration\".\"request_timeout\""},
	Active:          whereHelperbool{field: "\"weather_app2\".\"configuration\".\"active\""},
	Enable:          whereHelperbool{field: "\"weather_app2\".\"configuration\".\"enable\""},
	UserID:          whereHelperstring{field: "\"weather_app2\".\"configuration\".\"user_id\""},
}
...
type configurationR struct {
	RootAssets RootAssetSlice `boil:"RootAssets" json:"RootAssets" toml:"RootAssets" yaml:"RootAssets"`
}
...
func (o *Configuration) GetRootAssets() RootAssetSlice {
	if o == nil {
		return nil
	}

	return o.R.GetRootAssets()
}

func (r *configurationR) GetRootAssets() RootAssetSlice {
	if r == nil {
		return nil
	}
...
var (
	configurationAllColumns            = []string{"id", "tenant_id", "site_id", "refresh_interval", "request_timeout", "active", "enable", "user_id"}
	configurationColumnsWithoutDefault = []string{"tenant_id", "user_id"}
...
// RootAssets retrieves all the root_asset's RootAssets with an executor.
func (o *Configuration) RootAssets(mods ...qm.QueryMod) rootAssetQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"weather_app2\".\"root_asset\".\"configuration_id\"=?", o.ID),
	)

	return RootAssets(queryMods...)
}

// LoadRootAssets allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (configurationL) LoadRootAssets(ctx context.Context, e boil.ContextExecutor, singular bool, maybeConfiguration any, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`weather_app2.root_asset`),
		qm.WhereIn(`weather_app2.root_asset.configuration_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load root_asset")
	}

	var resultSlice []*RootAsset
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice root_asset")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on root_asset")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for root_asset")
	}
	...
	if singular {
		object.R.RootAssets = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &rootAssetR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.ConfigurationID {
				local.R.RootAssets = append(local.R.RootAssets, foreign)
				if foreign.R == nil {
					foreign.R = &rootAssetR{}
				}
...
// AddRootAssetsG adds the given related objects to the existing relationships
// of the configuration, optionally inserting them as new records.
// Appends related to o.R.RootAssets.
// Sets related.R.Configuration appropriately.
// Uses the global database handle.
func (o *Configuration) AddRootAssetsG(ctx context.Context, insert bool, related ...*RootAsset) error {
	return o.AddRootAssets(ctx, boil.GetContextDB(), insert, related...)
}

// AddRootAssets adds the given related objects to the existing relationships
// of the configuration, optionally inserting them as new records.
// Appends related to o.R.RootAssets.
// Sets related.R.Configuration appropriately.
func (o *Configuration) AddRootAssets(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*RootAsset) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.RootAssets = append(o.R.RootAssets, related...)
	}
...
func Configurations(mods ...qm.QueryMod) configurationQuery {
	mods = append(mods, qm.From("\"weather_app2\".\"configuration\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"weather_app2\".\"configuration\".*"})
	}
...
func FindConfiguration(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Configuration, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"weather_app2\".\"configuration\" where \"id\"=$1", sel,
	)
...
func (o *Configuration) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"weather_app2\".\"configuration\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"weather_app2\".\"configuration\" %sDEFAULT VALUES%s"
		}
...
func (o *Configuration) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"weather_app2\".\"configuration\" SET %s WHERE %s",
...
func (o ConfigurationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"weather_app2\".\"configuration\" SET %s WHERE %s",
...
func (o *Configuration) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"weather_app2\".\"configuration\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func (o *Configuration) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"weather_app2\".\"configuration\" WHERE \"id\"=$1"
...
func (o ConfigurationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"weather_app2\".\"configuration\" WHERE " +
...
func (o *ConfigurationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"weather_app2\".\"configuration\".* FROM \"weather_app2\".\"configuration\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, configurationPrimaryKeyColumns, len(*o))
...
func ConfigurationExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"weather_app2\".\"configuration\" where \"id\"=$1 limit 1)"
